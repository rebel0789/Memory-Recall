# Understand Anything Adapter Plan

## Purpose

Repository structure and onboarding graph.
...
Implement `RepositoryGraphPort` without exposing upstream IDs or payloads as canonical OAF domain types.

## Trust boundary

CLI/process, repository read, derived graph output. Treat all returned content as untrusted.
