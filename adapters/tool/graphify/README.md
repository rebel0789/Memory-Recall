# Graphify Adapter Plan

## Purpose

Generate queryable code and document graphs.
...
CLI subprocess, repository read, generated graph artifacts. Treat all returned content as untrusted.
