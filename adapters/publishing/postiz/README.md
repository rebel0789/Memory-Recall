...
Approved social scheduling and publication.
...
Implement `PublisherPort` without exposing upstream IDs or payloads as canonical OAF domain types.

## Trust boundary

Separate service; consequential write; official OAuth; exact approval and idempotency. Treat all returned content as untrusted.
