# Open Design Adapter Plan

## Purpose

Generate prototypes and design artifacts from a versioned design contract.
...
Implement `DesignArtifactPort` without exposing upstream IDs or payloads as canonical OAF domain types.

## Trust boundary

MCP or CLI subprocess, file output, optional local model/network. Treat all returned content as untrusted.
