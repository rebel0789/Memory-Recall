# Agent-Reach Adapter Plan

## Purpose

Read-side research capability routing.
...
CLI subprocess, network, optional browser-derived authentication. Treat all returned content as untrusted.
