# last30days-skill Adapter Plan

## Purpose

Recent public-signal research.
...
Implement `ResearchSourcePort` without exposing upstream IDs or payloads as canonical OAF domain types.

## Trust boundary

Networked read, platform terms, optional keys/cookies, untrusted content. Treat all returned content as untrusted.
