# OpenViking Adapter Plan

## Purpose

Filesystem-style tiered context experiment.
...
Separate service due maturity/license boundary; verify exact commit. Treat all returned content as untrusted.
