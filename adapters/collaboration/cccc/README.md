...
Agent rooms, handoffs, acknowledgements, and obligations.
...
Implement `CollaborationPort` without exposing upstream IDs or payloads as canonical OAF domain types.

## Trust boundary

Local service/MCP bridge; messages map to canonical OAF events. Treat all returned content as untrusted.
