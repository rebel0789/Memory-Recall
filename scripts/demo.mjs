...
if(manifest)console.log(`Context: ${manifest.selected.length} selected, ${manifest.excluded.length} excluded, ${manifest.budget.used}/${manifest.budget.available} estimated tokens`);
