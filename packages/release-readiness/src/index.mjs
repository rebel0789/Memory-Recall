...
- [x] Consumer-simple gates cover temp HOME install proof, real MCP client smoke, browser smoke for Connect, Token Saver, Add Memory, and Repo Map, and package-facing docs name hygiene.
