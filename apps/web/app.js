...
function renderSettings() {
  return `<div class="tool-workspace settings-workspace"><header class="tool-page-heading"><div><h1>Settings</h1><p>Inspect the local paths, scan bounds, and privacy rules used by this workspace.</p></div><span>Local workspace</span></header><section class="settings-grid"><section><div class="section-heading"><h2>Local storage</h2><span>Derived and governed state</span></div><dl class="facts facts-wide"><div><dt>Memory</dt><dd><code>.local/memory.sqlite</code></dd></div><div><dt>Source graph</dt><dd>Persistent native index when current; bounded in-memory fallback</dd></div><div><dt>Context packs</dt><dd><code>context-packs/</code> when explicitly pinned</dd></div></dl></section><section><div class="section-heading"><h2>Scan limits</h2><span>Bounded by default</span></div><dl class="facts facts-wide"><div><dt>Languages</dt><dd>14 indexed languages; JavaScript and TypeScript fallback</dd></div><div><dt>File size</dt><dd>512 KiB default</dd></div><div><dt>Graph display</dt><dd>200 nodes / 400 relationships</dd></div></dl></section><section><div class="section-heading"><h2>Privacy</h2><span>Offline default</span></div>${localBoundary()}<p class="muted">Map and read-only MCP responses expose bounded locators and metadata, never raw source bodies.</p></section></section></div>`;
}
