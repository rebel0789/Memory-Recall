...
- `initial-design-plan.md` — historical integration plan.

Load this directory only when revisiting the thesis or evaluating an adapter. For development truth, use `PROJECT_STATUS.json`, accepted ADRs/RFCs, schemas, tests, and the selected task.
