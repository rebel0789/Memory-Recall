...
test('CLI topic help treats valid help requests as read-only success',()=>{for(const [args,patterns] of [
  ...
  [['mcp','--help'],[/Memory Recall CLI: mcp/,/oaf mcp inspect --read-only --root \. --format json/,/oaf:\/\/workspace\/ws_local\/skills\/catalog/,/oaf mcp server --read-only --root \. --stdio/,/Resource\/server paths require/]]
