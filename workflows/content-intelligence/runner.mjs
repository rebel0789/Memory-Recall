...
export async function runContentIntelligence({emit=async()=>{},env=process.env,objective='Find evidence-backed content angles about reliable local agents',workspaceId='ws_local',actorId='agent:researcher',manifestRepository=null}={}) {
